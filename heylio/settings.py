...
SECRET_KEY = 'django-insecure-=l7-9)2$nwy&-m#sion_)l43a2j403q96l@98-vcc@sm9#nj5='
...
CORS_ALLOWED_ORIGIN_REGEXES = [
    r"^https://.*\.example\.com$",  # adjust to your domain
    r"^http://localhost:3000$",     # for local development
]

CORS_ALLOW_CREDENTIALS = True

ROOT_URLCONF = 'heylio.urls'
